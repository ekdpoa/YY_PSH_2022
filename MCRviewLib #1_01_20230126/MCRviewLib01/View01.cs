...
namespace MCRviewLib01
{
    public partial class View01 : Form
    {
        ...
        public void SetControls01()
        {
            ...
            Console.WriteLine("#################### numYY " + numYY);

            if (numYY < 0) 
            {
                hYY = (int)(150 - ((numYY / 1000.00) * 150 * -1));
                Console.WriteLine("#################### -hYY " + hYY);
            ...
            Console.WriteLine("#################### numCP " + numCP);

            if (numCP < 0) 
            {
                hCP = (int)(150 - ((numCP / 400.00) * 150 * -1));
                Console.WriteLine("#################### -hCP " + hCP);
            ...
            Console.WriteLine("#################### numYC " + numYC);

            if (numYC < 0) 
            {
                hYC = (int)(150 - ((numYC / 800.00) * 150 * -1));
                Console.WriteLine("#################### -hYC " + hYC);
            ...
            Console.WriteLine("#################### numMJ " + numMJ);

            if (numMJ < 0) 
            {
                hMJ = (int)(150 - ((numMJ / 600.00) * 150 * -1));
                Console.WriteLine("#################### -hMJ " + numMJ);
            ...
            Console.WriteLine("#################### numCS " + numCS);

            if (numCS < 0) 
            {
                hCS = (int)(150 - ((numCS / 600.00) * 150 * -1));
                Console.WriteLine("#################### -hCS " + hCS);
            ...
            Console.WriteLine("#################### numSC " + numSC);

            if (numSC < 0) 
            {
                hSC = (int)(150 - ((numSC / 700.00) * 150 * -1));
                Console.WriteLine("#################### -hSC " + hSC);
            ...
            Console.WriteLine("#################### numSR " + numSR);

            if (numSR < 0) 
            {
                hSR = (int)(150 - ((numSR / 600.00) * 150 * -1));
                Console.WriteLine("#################### -hSR " + hSR);
