    ...
    public partial class View03 : Form
    {
        ...
        */
        ...
        public void ChangeImage18kv()
        {
            ...
            //gta01_rds_pump_close = 1호기 발전상태, 발전할 때 열림(빨강)
            ...
            //gta02_rds_pump_close = 2호기 발전상태, 발전할 때 열림(빨강)
            ...
            //gta03_rds_pump_close = 3호기 발전상태, 발전할 때 열림(빨강)
            ...
            //gta04_rds_pump_close = 4호기 발전상태, 발전할 때 열림(빨강)
            ...
            //gta01_rds_gen_close = 1호기 양수상태, 양수할 때 열림(빨강)
            ...
            //gta02_rds_gen_close = 2호기 양수상태, 양수할 때 열림(빨강)
            ...
            //gta03_rds_gen_close = 3호기 양수상태, 양수할 때 열림(빨강)
            ...
            //gta04_rds_gen_close = 4호기 양수상태, 양수할 때 열림(빨강)
