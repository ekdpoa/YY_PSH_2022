...
namespace MCRviewLib03
{
    public partial class View03 : Form
    {
        ...
        */
        ...
        //ds3121
        int ds3121_open = -1;        //01GTA_005JS_160DI
        int ds3121_close = -1;       //01GTA_005JS_021DI

        //ds3221
        int ds3221_open = -1;        //02GTA_005JS_160DI
        int ds3221_close = -1;       //02GTA_005JS_021DI

        //ds3321
        int ds3321_open = -1;        //03GTA_005JS_160DI
        int ds3321_close = -1;       //03GTA_005JS_021DI

        //ds3421
        int ds3421_open = -1;        //04GTA_005JS_160DI
        int ds3421_close = -1;       //04GTA_005JS_021DI

        //cb3183
        int cb3183_open = -1;        //11GTA_001JD_160DI
        int cb3183_close = -1;       //11GTA_001JD_021DI

        //cb3283
        int cb3283_open = -1;        //12GTA_001JD_160DI
        int cb3283_close = -1;       //12GTA_001JD_021DI

        //sw01-01b
        int _01sw01_01b_incoming_open = -1;      //20LGA_1SW01B_160DI
        int _01sw01_01b_incoming_close = -1;     //20LGA_1SW01B_021DI
        int _02sw01_01b_incoming_open = -1;      //20LGA_2SW01B_160DI
        int _02sw01_01b_incoming_close = -1;     //20LGA_2SW01B_021DI

        //006js: 단로기 RDS(G), 발전상태 close = 양수상태
        int gta01_rds_gen_close = -1;       //1호기 006js 01GTA_006JS_021DI
        int gta02_rds_gen_close = -1;       //2호기 006js 02GTA_006JS_021DI
        int gta03_rds_gen_close = -1;       //3호기 006js 03GTA_006JS_021DI
        int gta04_rds_gen_close = -1;       //4호기 006js 04GTA_006JS_021DI

        //007js: 단로기 RDS(P), 양수상태 close = 발전상태
        int gta01_rds_pump_close = -1;        //1호기 007js 01GTA_007JS_021DI
        int gta02_rds_pump_close = -1;        //2호기 007js 02GTA_007JS_021DI
        int gta03_rds_pump_close = -1;        //3호기 007js 03GTA_007JS_021DI
        int gta04_rds_pump_close = -1;        //4호기 007js 04GTA_007JS_021DI
        ...
        //ds3122
        int ds3122_open = -1;        //01GTA_005JS_160DI
        int ds3122_close = -1;       //01GTA_005JS_021DI

        //ds3222
        int ds3222_open = -1;        //02GTA_004JS_160DI
        int ds3222_close = -1;       //02GTA_004JS_021DI

        //ds3322
        int ds3322_open = -1;        //03GTA_004JS_160DI
        int ds3322_close = -1;       //03GTA_004JS_021DI

        //ds3422
        int ds3422_open = -1;        //04GTA_004JS_160DI
        int ds3422_close = -1;       //04GTA_004JS_021DI

        //ds3128-2
        int ds3128_2_open = -1;      //01GTA_002JS_160DI
        int ds3128_2_close = -1;     //01GTA_002JS_021DI

        //ds3228-2
        int ds3228_2_open = -1;      //02GTA_002JS_160DI
        int ds3228_2_close = -1;     //02GTA_002JS_021DI

        //ds3328-2
        int ds3328_2_open = -1;      //03GTA_002JS_160DI
        int ds3328_2_close = -1;     //03GTA_002JS_021DI

        //ds3428-2
        int ds3428_2_open = -1;      //04GTA_002JS_160DI
        int ds3428_2_close = -1;     //04GTA_002JS_021DI

        //cb31
        int cb31_open = -1;          //20GTA_001JD_160DI
        int cb31_close = -1;         //20GTA_001JD_021DI

        //cb32
        int cb32_open = -1;          //20SFC_002JD_160DI
        int cb32_close = -1;         //20SFC_002JD_021DI

        //11gta 001js
        int ds3001_open = -1;        //11GTA_001JS_160DI
        int ds3001_close = -1;       //11GTA_001JS_021DI

        //12gta 001js
        int ds3002_open = -1;        //12GTA_001JS_160DI
        int ds3002_close = -1;       //12GTA_001JS_021DI

        //ds3128-1
        int ds3128_1_open = -1;      //01GTA_003JS_160DI
        int ds3128_1_close = -1;     //01GTA_003JS_021DI

        //ds3228-1
        int ds3228_1_open = -1;      //02GTA_003JS_160DI
        int ds3228_1_close = -1;     //02GTA_003JS_021DI

        //ds3328-1
        int ds3328_1_open = -1;      //03GTA_003JS_160DI
        int ds3328_1_close = -1;     //03GTA_003JS_021DI

        //ds3428-1
        int ds3428_1_open = -1;      //04GTA_003JS_160DI
        int ds3428_1_close = -1;     //04GTA_003JS_021DI
        ...
        private void timer_get_value_09_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //006js: 단로기 RDS(G), 발전상태 close = 양수상태 01GTA_006JS_021DI, 02GTA_006JS_021DI, ..
                    ...
                    //007js: 단로기 RDS(P), 양수상태 close = 발전상태 01GTA_007JS_021DI, 02GTA_007JS_021DI, ..
        ...
        {
            //ds3121
            //if (ds3121_open == 0) { pic_ds3121.Image = Bitmap.FromFile("img\\DS_closed_vertical.png"); }
            ...
            //엔진 그림 변경하는 부분
            //20230308 수정 dy: 엔진 바로 위의 cb만 체크 -> cb, 006js, 007js 3개 체크로 수정
            ...
            */
            ...
            if (gta01_rds_pump_close == 0) { pic_gta01_006js_g.Image = Properties.Resources.opened_vertical; }
            else { pic_gta01_006js_g.Image = Properties.Resources.closed_vertical; }

            //gta02_rds_pump_close
            if (gta02_rds_pump_close == 0) { pic_gta02_006js_g.Image = Properties.Resources.opened_vertical; }
            else { pic_gta02_006js_g.Image = Properties.Resources.closed_vertical; }

            //gta03_rds_pump_close
            if (gta03_rds_pump_close == 0) { pic_gta03_006js_g.Image = Properties.Resources.opened_vertical; }
            else { pic_gta03_006js_g.Image = Properties.Resources.closed_vertical; }

            //gta04_rds_pump_close
            if (gta04_rds_pump_close == 0) { pic_gta04_006js_g.Image = Properties.Resources.opened_vertical; }
            else { pic_gta04_006js_g.Image = Properties.Resources.closed_vertical; }

            //gta01_rds_gen_close
            if (gta01_rds_gen_close == 0) { pic_gta01_007js_p.Image = Properties.Resources.opened_vertical; }
            else { pic_gta01_007js_p.Image = Properties.Resources.closed_vertical; }

            //gta02_rds_gen_close
            if (gta02_rds_gen_close == 0) { pic_gta02_007js_p.Image = Properties.Resources.opened_vertical; }
            else { pic_gta02_007js_p.Image = Properties.Resources.closed_vertical; }

            //gta03_rds_gen_close
            if (gta03_rds_gen_close == 0) { pic_gta03_007js_p.Image = Properties.Resources.opened_vertical; }
            else { pic_gta03_007js_p.Image = Properties.Resources.closed_vertical; }

            //gta04_rds_gen_close
            if (gta04_rds_gen_close == 0) { pic_gta04_007js_p.Image = Properties.Resources.opened_vertical; }
