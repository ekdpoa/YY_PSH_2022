...
{
    public partial class View12 : Form
    {
        ...
        {
            //20221201 1~6 수계, 7~ 발전
            comboBox2.SelectedIndex = 22;    //공수전리 방류2국
            comboBox3.SelectedIndex = 23;    //공수전리 파출소
            comboBox4.SelectedIndex = 35;    //영덕리 하부댐공원
            comboBox5.SelectedIndex = 31;    //용소리 잠수교
            comboBox6.SelectedIndex = 45;    //영덕리 나눔터가든
            comboBox7.SelectedIndex = 41;    //영덕리 38야영장
        ...
        public void DrawPicture()
        {
           ...
           int  result = Netcam.ndassock_setdisplay(pnetcam01, dispictureBox1.Handle);
            Console.WriteLine("cam句柄 " + dispictureBox1.Handle + "返回值" + result);
        ...
        //test
        public void SetDisplayCH1()
        {
            //this.btn_stop_Click(this, null);
            
            dispictureBox1.BringToFront();
            dispictureBox1.SetBounds(0, 0, 1920, 1080);
            int result = Netcam.ndassock_setdisplay(disparam01.pnetcamP, dispictureBox1.Handle);

            //this.btn_play_Click(this, null);
        }

        //0109
        //test
        //공수전리 공수전교
        public void dispictureBox1_Click(object sender, EventArgs e)
        {
            dispictureBox1.BringToFront();
            dispictureBox1.SetBounds(0, 0, 1920, 1080);
            int result = Netcam.ndassock_setdisplay(disparam01.pnetcamP, dispictureBox1.Handle);
        ...
        public void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            pictureBox1.SetBounds(0, 0, 1920, 1080);
            int result = Netcam.ndassock_setdisplay(disparam02.pnetcamP, pictureBox1.Handle);
        }
        ...
        public void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            pictureBox2.SetBounds(0, 0, 1920, 1080);
            int result = Netcam.ndassock_setdisplay(disparam03.pnetcamP, pictureBox2.Handle);
        }
        ...
        public void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            pictureBox3.SetBounds(0, 0, 1920, 1080);
            int result = Netcam.ndassock_setdisplay(disparam04.pnetcamP, pictureBox3.Handle);
        }
        ...
        public void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            pictureBox4.SetBounds(0, 0, 1920, 1080);
            int result = Netcam.ndassock_setdisplay(disparam05.pnetcamP, pictureBox4.Handle);
        }
        ...
        public void pictureBox5_Click(object sender, EventArgs e)
        {
            ...
            pictureBox5.SetBounds(0, 0, 1920, 1080);
            int result = Netcam.ndassock_setdisplay(disparam06.pnetcamP, pictureBox5.Handle);
        }
        ...
        //20220808sh SetRuntimeView 
        public void SetRuntimeView()
        {
            //20220808sh
            //공수전리 공수전교
            disparam01.Channel = "2";
            //disparam01.Channel = "43";
            //disparam01.Channel = comboBox2.SelectedItem.ToString();
            dispictureBox1.SetBounds(444, 102, 455, 245);
            ...
            //공수전리 공수전보
            disparam02.Channel = "1";
            //disparam02.Channel = "32";
            //disparam02.Channel = comboBox3.SelectedItem.ToString();
            pictureBox1.SetBounds(1247, 63, 455, 245);
            ...
            //영덕리 하부댐공원
            disparam03.Channel = "4";
            //disparam03.Channel = "40";
            //disparam03.Channel = comboBox4.SelectedItem.ToString();
            pictureBox2.SetBounds(400, 441, 455, 245);
            ...
            //용소리 잠수교
            disparam04.Channel = "3";
            //disparam04.Channel = "42";
            //disparam04.Channel = comboBox5.SelectedItem.ToString();
            pictureBox3.SetBounds(1166, 402, 455, 245);
            ...
            //서림리 서림가든
            disparam05.Channel = "6";
            //disparam05.Channel = "43";
            //disparam05.Channel = comboBox6.SelectedItem.ToString();
            pictureBox4.SetBounds(221, 773, 455, 245);
            ...
            //영덕리 38야영장
            disparam06.Channel = "5";
            //disparam06.Channel = "36";
            //disparam06.Channel = comboBox7.SelectedItem.ToString();
            pictureBox5.SetBounds(1112, 729, 455, 245);
        ...
        void PlayRuntimeView(object disparam)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Liveplay: " + result);
                ...
                while (true)
                {
                    ...
                    if (ret == Netcam.KILL_STATUS_FAILED || ret == Netcam.KILL_STATUS_DISCONNECTED)
                    {
                        ...
                        Console.WriteLine("시간: " + dateTime + ", 위치: " + th_disparam.Boxname + ", 채널: " + th_disparam.Channel);

                        // 20220822dy 영상이 멈춘다면 다시 재생하기
                        // th_disparam에 문제가 생기면 영상 재생도 실패함
                        // th_disparam 초기화하고 문제가 생긴 영상을 제거한 다음 다시 PlayRuntimeView 실행
                ...
                // 액세스 위반은 일반적으로 잘못된 포인터를 통해 여러 차례 읽기 또는 쓰기 작업을 수행하여
                // 메모리가 손상되었을 수 있음을 나타냅니다.
                if (th_disparam.pnetcamP != null) { Netcam.ndassock_stop(th_disparam.pnetcamP);}
                if (th_disparam.pnetcamP != null) { Netcam.ndassock_disconnect(th_disparam.pnetcamP);}
                if (th_disparam.pnetcamP != null) { Netcam.netcam_destroy(th_disparam.pnetcamP);}
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            if (bootpath == "")
            {
                MessageBox.Show("경로 이름이 비어 있습니다");
                return;
            }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            /*
            dispictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            ...
            //dispictureBox1.Image = global::NdasSDKDemo.Properties.Resources.backgrounddisp;
            */
        ...
        {
            // 공수전리 공수전교
            pictureBox16.SetBounds(444-2, 102-2, 459, 249);

            // 공수전리 공수전보
            pictureBox17.SetBounds(1247-2, 63-2, 459, 249);

            // 영덕리 하부댐공원
            pictureBox18.SetBounds(400-2, 441-2, 459, 249);

            // 용소리 잠수교
            pictureBox19.SetBounds(1166-2, 402-2, 459, 249);

            // 서림리 서림가든
            pictureBox20.SetBounds(221-2, 773-2, 459, 249);

            // 영덕리 38야영장
            pictureBox21.SetBounds(1112-2, 729-2, 459, 249);
        ...
        {
            if (View12.isdisplay == 1)
            {
                MessageBox.Show("请关闭视频预览后再进行回放！");
                View12.m_stSearch = false;
                return;
            }
            ...
            playbackparam.issearch = View12.m_stSearch;
        ...
        private void playback(object playbackparam)
        {
            ...
            View12.playbacknetcam = pnetcam1;
        ...
        //20221024dy cctv 크게 보는 기능
        public void UpdateFullView(string id)
        {
            if (id.Equals(1))
            {
                dispictureBox1.SetBounds(1, 1, 1920, 1080);
                dispictureBox1.BringToFront();
            }
            else if (id.Equals(2))
            {
                pictureBox1.SetBounds(1, 1, 1920, 1080);
                pictureBox1.BringToFront();
            }
            else if (id.Equals(3))
            {
                pictureBox2.SetBounds(1, 1, 1920, 1080);
                pictureBox2.BringToFront();
            }
            else if (id.Equals(4))
            {
                pictureBox3.SetBounds(1, 1, 1920, 1080);
                pictureBox3.BringToFront();
            }
            else if (id.Equals(5))
            {
                pictureBox4.SetBounds(1, 1, 1920, 1080);
                pictureBox4.BringToFront();
            }
            else if (id.Equals(6))
            {
                pictureBox5.SetBounds(1, 1, 1920, 1080);
                pictureBox5.BringToFront();
            }
            else if (id.Equals(7))
            {
                pictureBox6.SetBounds(1, 1, 1920, 1080);
                pictureBox6.BringToFront();
            }
            else if (id.Equals(8))
            {
                pictureBox7.SetBounds(1, 1, 1920, 1080);
                pictureBox7.BringToFront();
            }
        }

        //20221024dy 추가
        public void UpdateDefaultView(string id)
        {
            if (id.Equals(1))
            {
                dispictureBox1.SetBounds(790, 260, 300, 150);
                dispictureBox1.BringToFront();
            }
            else if (id.Equals(2))
            {
                pictureBox1.SetBounds(1230, 230, 300, 150);
                pictureBox1.BringToFront();
            }
            else if (id.Equals(3))
            {
                pictureBox2.SetBounds(600, 540, 300, 150);
                pictureBox2.BringToFront();
            }
            else if (id.Equals(4))
            {
                pictureBox3.SetBounds(1200, 510, 300, 150);
                pictureBox3.BringToFront();
            }
            else if (id.Equals(5))
            {
                pictureBox4.SetBounds(400, 790, 300, 150);
                pictureBox4.BringToFront();
            }
            else if (id.Equals(6))
            {
                pictureBox5.SetBounds(1050, 750, 300, 150);
                pictureBox5.BringToFront();
            }
            else if (id.Equals(7))
            {
                pictureBox6.SetBounds(1350, 10, 300, 150);
                pictureBox6.BringToFront();
            }
            else if (id.Equals(8))
            {
                pictureBox7.SetBounds(30, 700, 300, 150);
                pictureBox7.BringToFront();
            }
        }

        private void View12_FormClosed(object sender, FormClosedEventArgs e)
        {
            DisplayParam.stop = 0;
            Application.Exit();
        }
