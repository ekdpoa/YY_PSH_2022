...
namespace MCRviewLib13
{
    public partial class View13 : Form
    {
        ...
        private void InitializeCefSharp()
        {
            ...
            */
            ...
            //태풍통보문
            browser = new ChromiumWebBrowser("http://192.168.10.2:8094");
            //1209 날씨예보 웹
            //browser = new ChromiumWebBrowser("http://192.168.10.2:8095");
            //browser = new ChromiumWebBrowser("https://embed.windy.com/embed2.html?lat=35.199&lon=129.534&detailLat=35.199&detailLon=129.534&width=650&height=450&zoom=7&level=surface&overlay=rain&product=ecmwf&menu=&message=&marker=&calendar=now&pressure=&type=map&location=coordinates&detail=&metricWind=default&metricTemp=default&radarRange=-1");
        ...
        private void View13_Load(object sender, EventArgs e)
        {
            ...
            //timer_RefreshWeb.Interval = 1000 * 60 * 15;     //15분
        ...
        public void MemoryCheck()
        {
            ...
            //Process[] all2 = Process.GetProcessesByName("MCRviewLib13");
            foreach (Process thisProc in all2.OrderBy(x => x.ProcessName))
            {
                ...
                */
                ...
                Process[] all1 = Process.GetProcessesByName("MCRviewLib13");
