...
namespace OPCDATest2
{
    public partial class frmMain : Form
    {
        ...
        {
            //읽어올 DCS태그 이름 넣기
            string[] opcTag = {"MCR.41HVA_301VN_011AR2", "MCR.41HVA_301VN_OUTFLOW", "MCR.41HVA_302VN_011AR2",
                                "MCR.41HVA_302VN_OUTFLOW", "MCR.41HVA_303VN_011AR2", "MCR.41HVA_303VN_OUTFLOW",
                                "MCR.41HVA_304VN_011AR2", "MCR.41HVA_304VN_OUTFLOW", "MCR.41GTA_GCP1_AP_05AR",
                                "MCR.41GTA_FI_001_04AR", "MCR.42GTA_GCP2_AP_05AR", "MCR.42GTA_FI_002_04AR",
                                "MCR.43GTA_GCP3_AP_05AR", "MCR.43GTA_FI_003_04AR", "MCR.42HVA_ZIT_101VN",
                                "MCR.42HVA_FQIT101_SEC", "MCR.42HVA_ZIT_401VN", "MCR.42HVA_401VN_OUTFLOW",
                                "MCR.42HVA_ZIT_501VN", "MCR.42HVA_501VN_OUTFLOW"};
        ...
        public void QueryConnDS()
        {
            try
            {
                ...
                */
                ...
                m_CmdTextDS = @"UPDATE ALL_HYDRO_ROAD SET YY_LOG_DATE = TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS'), "
                                +  "YY_41HVA_301VN_011AR2 = '" + a2 +
                                "', YY_41HVA_301VN_OUTFLOW = '" + a3 +
                                "', YY_41HVA_302VN_011AR2 = '" + a4 +
                                "', YY_41HVA_302VN_OUTFLOW = '" + a5 +
                                "', YY_41HVA_303VN_011AR2 = '" + a6 +
                                "', YY_41HVA_303VN_OUTFLOW = '" + a7 +
                                "', YY_41HVA_304VN_011AR2 = '" + a8 +
                                "', YY_41HVA_304VN_OUTFLOW = '" + a9 +
                                "', YY_41GTA_GCP1_AP_05AR = '" + a10 +
                                "', YY_41GTA_FI_001_04AR = '" + a11 +
                                "', YY_42GTA_GCP1_AP_05AR = '" + a12 +
                                "', YY_42GTA_FI_002_04AR = '" + a13 +
                                "', YY_43GTA_GCP1_AP_05AR = '" + a14 +
                                "', YY_43GTA_FI_003_04AR = '" + a15 +
                                "', YY_42HVA_ZIT_101VN = '" + a16 +
                                "', YY_42HVA_FQIT101_SEC = '" + a17 +
                                "', YY_42HVA_ZIT_401VN = '" + a18 +
                                "', YY_42HVA_FQIT401_SEC = '" + a19 +
                                "', YY_42HVA_ZIT_501VN = '" + a20 +
                                "', YY_42HVA_FQIT501_SEC = '" + a21 +
                                "' WHERE ROWNUM = 1";
