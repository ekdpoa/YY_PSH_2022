...
namespace OPCDATest2
{
    public partial class frmMain : Form
    {
        ...
        {
            //읽어올 DCS태그 이름 넣기
            string[] opcTag = {"MCR.UR_SELECLVL_16AR", "MCR.31KMH_RAINFALL_1DAY", "MCR.31HVA_TEMP_017AR", 
                                "MCR.41KMH_001LVL_16AR", "MCR.41KMH_RAINFALL_1DAY", "MCR.41HVA_TEMP_017AR", 
                                "MCR.41HVA_10MIN_INFLOW", "MCR.41HVA_10MIN_OUTFLOW", "MCR.41KMH_VOLUMN_15AR", 
                                "MCR.SURPLUS_VOLUMN_15AR", "MCR.31KMH_VOLUMN_15AR", "MCR.41HVA_1HOUR_INFLOW"};
        ...
        */
        ...
        public void InitConnDS()
        {
            ...
            listBox2.Items.Add("InitConnDS proc complete");
        }
        ...
        public void QueryConnDS()
        {
            try
            {
                ...
                /*
                m_CmdTextDS = @"insert into HYDRO_OPERATION values(" + "TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')" + ", '"
                    + a2  + "', '" + a3  + "', '" + a4  + "', '" + a5  + "', '" + a6  + "', '" 
                    + a7  + "', '" + a8  + "', '" + a9  + "', '" + a10 + "', '" + a11 + "')";
                */
                ...
                */
                ...
                m_CmdTextDS = @"UPDATE HYDRO_OPERATION SET YY_LOG_DATE = TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS'), "
                                + "YY_UR_SELECLVL_16AR = '" + a2 +
                                "', YY_31KMH_RAINFALL_1DAY = '" + a3 +
                                "', YY_31HVA_TEMP_017AR = '" + a4 +
                                "', YY_41KMH_001LVL_16AR = '" + a5 +
                                "', YY_41KMH_RAINFALL_1DAY = '" + a6 +
                                "', YY_41HVA_TEMP_017AR = '" + a7 +
                                "', YY_41HVA_10MIN_INFLOW = '" + a8 +
                                "', YY_41HVA_10MIN_OUTFLOW = '" + a9 +
                                "', YY_41KMH_VOLUMN_15AR = '" + a10 +
                                "', YY_SURPLUS_VOLUMN_15AR = '" + a11 +
                                "', YY_31KMH_VOLUMN_15AR = '" + a12 +
                                "', YY_41HVA_1HOUR_INFLOW = '" + a13 +
                                "' WHERE ROWNUM = 1";
        ...
        {
            if (listBox1.Items.Count < 10) return;
