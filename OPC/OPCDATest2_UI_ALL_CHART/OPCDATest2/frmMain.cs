...
namespace OPCDATest2
{
    public partial class frmMain : Form
    {
        ...
        {
            //읽어올 DCS태그 이름 넣기
            string[] opcTag = {"MCR.31KMH_RAINFALL_1HOUR", "MCR.31KMH_RAINFALL_1DAY", "MCR.UR_SELECLVL_16AR",
                                "MCR.31KMH_VOLUMN_15AR", "MCR.31KMH_VOLUMNRATE_15AR", "MCR.41KMH_RAINFALL_1HOUR",
                                "MCR.41KMH_RAINFALL_1DAY", "MCR.41KMH_001LVL_16AR", "MCR.41KMH_VOLUMN_15AR",
                                "MCR.41KMH_VOLUMNRATE_15AR", "MCR.SURPLUS_VOLUMN_INTERNAL", "MCR.41HVA_10MIN_INFLOW",
                                "MCR.41HVA_1HOUR_INFLOW", "MCR.41HVA_10MIN_OUTFLOW", "MCR.41HVA_1H_OUTFLOW",
                                "MCR.GATE_TOTAL_OUTFLOW", "MCR.F/W_TOTAL_OUTFLOW", "MCR.S/H_TOTAL_OUTFLOW",
                                "MCR.43HVA_F101_SEC", "MCR.41HVA_301VN_011AR2", "MCR.41HVA_301VN_OUTFLOW",
                                "MCR.41HVA_302VN_011AR2", "MCR.41HVA_302VN_OUTFLOW", "MCR.41HVA_303VN_011AR2",
                                "MCR.41HVA_303VN_OUTFLOW", "MCR.41HVA_304VN_011AR2", "MCR.41HVA_304VN_OUTFLOW",
                                "MCR.41GTA_FI_001_04AR", "MCR.42GTA_FI_002_04AR", "MCR.43GTA_FI_003_04AR",
                                "MCR.42HVA_FQIT101_SEC", "MCR.42HVA_401VN_OUTFLOW", "MCR.42HVA_501VN_OUTFLOW",
                                "MCR.01GTA_001UM_05AR33", "MCR.02GTA_001UM_05AR33", "MCR.03GTA_001UM_05AR33", 
                                "MCR.04GTA_001UM_05AR33", "MCR.99KSC_GIS_BUS1_FREQ", "MCR.20SXD_PIT_13AI", 
                                "MCR.20SXD_001PO_020DI", "MCR.20SXD_002PO_020DI", "MCR.20SXD_003PO_020DI", 
                                "MCR.20SXD_004PO_020DI"};
        ...
        public void QueryConnDS()
        {
            try
            {
                ...
                */
                ...
                m_CmdTextDS = @"UPDATE UI_ALL_CHART SET YY_LOG_DATE = TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS'), "
                                + "YY_31KMH_RAINFALL_1HOUR = '" + a2 +
                                "', YY_31KMH_RAINFALL_1DAY  = '" + a3 +
                                "', YY_UR_SELECLVL_16AR     = '" + a4 +
                                "', YY_31KMH_VOLUMN_15AR    = '" + a5 +
                                "', YY_31KMH_VOLUMNRATE_15AR = '" + a6 +
                                "', YY_41KMH_RAINFALL_1HOUR  = '" + a7 +
                                "', YY_41KMH_RAINFALL_1DAY   = '" + a8 +
                                "', YY_41KMH_001LVL_16AR     = '" + a9 +
                                "', YY_41KMH_VOLUMN_15AR     = '" + a10 +
                                "', YY_41KMH_VOLUMNRATE_15AR = '" + a11 +
                                "', YY_SURPLUS_VOLUMN_INTERNAL = '" + a12 +
                                "', YY_41HVA_10MIN_INFLOW  = '" + a13 +
                                "', YY_41HVA_1HOUR_INFLOW  = '" + a14 +
                                "', YY_41HVA_10MIN_OUTFLOW = '" + a15 +
                                "', YY_41HVA_1H_OUTFLOW    = '" + a16 +
                                "', YY_GATE_TOTAL_OUTFLOW  = '" + a17 +
                                "', YY_FW_TOTAL_OUTFLOW    = '" + a18 +
                                "', YY_SH_TOTAL_OUTFLOW    = '" + a19 +
                                "', YY_43HVA_F101_SEC      = '" + a20 +
                                "', YY_41HVA_301VN_011AR2  = '" + a21 +
                                "', YY_41HVA_301VN_OUTFLOW = '" + a22 +
                                "', YY_41HVA_302VN_011AR2  = '" + a23 +
                                "', YY_41HVA_302VN_OUTFLOW = '" + a24 +
                                "', YY_41HVA_303VN_011AR2  = '" + a25 +
                                "', YY_41HVA_303VN_OUTFLOW = '" + a26 +
                                "', YY_41HVA_304VN_011AR2  = '" + a27 +
                                "', YY_41HVA_304VN_OUTFLOW = '" + a28 +
                                "', YY_41GTA_FI_001_04AR = '" + a29 +
                                "', YY_42GTA_FI_002_04AR = '" + a30 +
                                "', YY_43GTA_FI_003_04AR = '" + a31 +
                                "', YY_42HVA_FQIT101_SEC = '" + a32 +
                                "', YY_42HVA_401VN_OUTFLOW = '" + a33 +
                                "', YY_42HVA_501VN_OUTFLOW = '" + a34 +
                                "', YY_01GTA_001UM_05AR33  = '" + a35 +
                                "', YY_02GTA_001UM_05AR33  = '" + a36 +
                                "', YY_03GTA_001UM_05AR33  = '" + a37 +
                                "', YY_04GTA_001UM_05AR33  = '" + a38 +
                                "', YY_99KSC_GIS_BUS1_FREQ = '" + a39 +
                                "', YY_20SXD_PIT_13AI      = '" + a40 +
                                "', YY_20SXD_001PO_020DI = '" + a41 +
                                "', YY_20SXD_002PO_020DI = '" + a42 +
                                "', YY_20SXD_003PO_020DI = '" + a43 +
                                "', YY_20SXD_004PO_020DI = '" + a44 +
                                "' WHERE ROWNUM = 1";
